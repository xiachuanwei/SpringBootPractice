...
//        SpringApplication.run(SpringbootUtilsApplication.class, args);
        DBInfo dbInfo = new DBInfo("com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/test?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true", "root", "root");
        System.out.println(DatabaseConnTool.querySql("select * from test", dbInfo).size());
    }
